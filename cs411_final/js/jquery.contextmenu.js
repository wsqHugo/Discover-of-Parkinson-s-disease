(function($) {
    ...
    $.fn.contextmenu = function(option) {
        ...
        itemTpl = "<div class='b-m-$[type]' unselectable=on><nobr unselectable=on><i class='$[icon]' align='absmiddle'></i><span unselectable=on>$[text]</span></nobr></div>";
        ...
        function showMenu(e, menutarget) {
            target = menutarget;
            showMenuGroup.call(groups[option.alias]/*.cmroot*/, { left: e.pageX, top: e.pageY }, 0);
