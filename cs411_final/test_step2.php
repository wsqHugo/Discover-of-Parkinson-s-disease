	...
	<div id="container">
		...
		<div>
	      <table class="box">
	        <thead>
	          <tr>
	            <th class='ui-state-default'><h3>Tutorial</h3></th>
	          </tr>
	        </thead>
	        <tbody>
			<tr>
		      <td>
		        <br>
		        <video width="700" controls="controls" maigin="center">
		          <?php
		            echo '<source src="tutorial.mp4" type="video/mp4">';
		          ?>
		        </video>
		      </td>
		    </tr>
		...
		<form action="upload.php" method="post" enctype="multipart/form-data">
			...
			<button id="px-view" type="reset">Process Video</button>
		</form>
		<script type="text/javascript">
			jQuery(function($){
